...
import { InitialRequest, ParentRequest, PrepareRequest } from ".";

import { CACHE_MANAGER_KEY, CU_IS_EDIT_KEY, IFORM_KEY } from "../keys";
      ...
      await axios.buildResponses({
        ...
        requests: [
          axios.fetchResponse({
            ...
            data: props.useMultipart ? multipartData(entity) : entity,
            headers: {
              "Content-Type": props.useMultipart
                ? "multipart/form-data"
                : "application/json",
            },
          }),
